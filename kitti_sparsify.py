...
if __name__ == '__main__':
    ...
    parser.add_argument('--pl_path', default='data/KITTI/object/testing/pseudo_lidar', help='pseudo-lidar path')
    parser.add_argument('--sparse_pl_path', default='data/KITTI/object/testing/velodyne', help='sparsed pseudo lidar path')
